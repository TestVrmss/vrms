...
//
//public final class JavaMailGateway implements MailGateway {
...
//       properties.put("mail.smtp.auth", Boolean.toString(settings.isAuthenticationEnabled()));
//       properties.put("mail.smtp.starttls.enable", Boolean.toString(settings.isStartTlsEnabled()));
//
//       Session session;
