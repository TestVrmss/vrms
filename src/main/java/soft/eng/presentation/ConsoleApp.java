...
//
//  
//   public ConsoleApp(Scanner scanner, AuthService authService, VehicleCatalogService catalogService,
//                     RentalService rentalService, RentalReminderService reminderService) {
...
//               auth, rentals, vehicles, new DefaultRentalValidationStrategy(),
...
//       System.out.println(authService.login(username, password) ? "Login successful." : "Invalid credentials.");
//   }
//
